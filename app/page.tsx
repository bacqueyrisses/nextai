  ...
  return (
      <>
        <Container className="mt-10 sm:mt-16">
          <div
              className="relative -mx-2 px-4 py-10 bg-stone-100 sm:-mx-6 sm:px-6 md:mx-0 rounded-4xl md:px-16 xl:px-24">
        ...
        <Container className="mt-10 sm:mt-20">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-xl text-neutral-600">
              AI-driven search for a effortless Next.JS documentation exploration. Daily updated.
            </p>
          </div>
        </Container>
        <SearchContainer/>
