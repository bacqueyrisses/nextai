...
export default function Header() {
  return (
    <div className={"flex self-center flex-col gap-5 justify-center items-center font-medium w-full"}>
      {/*<div className={"flex items-center justify-center"}>*/}
      {/*<Image className={"filter-white"} src={"/images/flash-white.svg"} alt={"logo nextai"} width={30} height={30}/>*/}
      <div className={"text-white text-2xl py-3 flex gap-2 justify-center items-center bg-black rounded-xl w-1/3"}>
      ...
      <div className={"text-4xl"}>The AI powered Next.JS Doc Search</div>
